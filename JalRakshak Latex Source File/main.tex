...
\begin{minipage}{0.35\textwidth}
       \hspace*{-47pt}\raisebox{-122.5pt}{\includegraphics[width=\linewidth]{111.png}}
    \end{minipage}%  
...
\centering\begin{tikzpicture}[node distance=0.7cm and 1.15cm,scale=.72,transform shape]
...
\column{0.45\textwidth}\centering\placeholderimage{images/dashboard.png}{5.6cm}{4.2cm}\end{columns}
\end{frame}
...
\begin{tabular}{cc}
\placeholderimage{images/sdg3.png}{1.1cm}{1.1cm} & \placeholderimage{images/sdg6.png}{1.1cm}{1.1cm}\\[0.08cm]
\placeholderimage{images/sdg11.png}{1.1cm}{1.1cm} & \placeholderimage{images/sdg13.png}{1.1cm}{1.1cm}
\end{tabular}}\end{columns}
\end{frame}
...
\centering\placeholderimage{images/dashboard.png}{4.4cm}{2.7cm}\hspace{0.15cm}\placeholderimage{images/iot_hardware.png}{4.4cm}{2.7cm}\hspace{0.15cm}\placeholderimage{images/chatbot.png}{4.4cm}{2.7cm}\vspace{0.35cm}
...
\centering\color{white}\vspace{1.4cm}{\Huge\bfseries Thank You}\\[0.4cm]{\LARGE Questions?}\\[0.6cm]{\Large Team Northeastnerds}\\[0.4cm]\chip{JRCyan}{Real ML} \chip{JRAqua}{IoT Prototype} \chip{JRWarn}{PWA Offline} \chip{JRLow}{AI Chatbot}
\end{frame}
